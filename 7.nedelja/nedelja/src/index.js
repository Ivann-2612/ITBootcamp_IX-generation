...
//     app.style.display = 'flex'
//     app.style.marginLeft = '35px'
//     app.style.flexWrap = 'wrap'
//     const div = document.createElement('div')
//     div.style.border = '2px solid black'
//     div.style.boxShadow = '2px 2px 2px gray'
//     div.style.margin = '5px'
//     div.style.width = '250px'
//     div.style.padding = '10px'
//     div.style.backgroundColor = '#f1f5f8'
//     const h3Name = document.createElement('h3')
//     h3Name.textContent = `Country: ${country.name}`
//     h3Name.style.borderBottom = '1px solid black'
//     const paraRegion = document.createElement('p')
//     paraRegion.textContent = `Region: ${country.region}`
//     const paraCapital = document.createElement('p')
//     paraCapital.textContent = `Capital: ${country.capital}`
//     const paraTimeZone = document.createElement('p')
//     paraTimeZone.textContent = `Time zone: ${country.timezones[0]}`
//     const imgFlag = document.createElement('img')
//     imgFlag.style.maxWidth = '50px'
//     imgFlag.style.maxHeight = '50px'
//     imgFlag.style.objectFit = 'contain'
//     imgFlag.src = country.flag

//     div.append(h3Name,imgFlag,paraCapital,paraRegion,paraTimeZone)
//     app.append(div)
// }


// axios.get('https://restcountries.eu/rest/v2/all')
//     .then(res => res.data.forEach(element =>  getCountries(element) ))

    //.then(res => console.log(res.data[0].flag))
